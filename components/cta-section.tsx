				...
				<div className='flex flex-col justify-center items-center w-full'>
					<div className='relative flex flex-col justify-center items-center w-full overflow-hidden'>
						...
						<div className='z-10 absolute'>
							<div className='bg-black/10  shadow-2xl backdrop-blur-md mx-auto p-3 border rounded-[2rem] size-24 lg:size-32'>
								<HeartHandshake className='mx-auto text-white  size-16 lg:size-24' />
							</div>
							<div className='z-10 flex flex-col items-center mt-4 text-center text-black'>
								<h1 className='font-bold text-3xl lg:text-4xl bg-white'>
									Stop compromising with your Time.
								</h1>
								<p className='mt-2 bg-white'>
									Create your dummy ticket now. No hidden fees.
								</p>
							</div>
